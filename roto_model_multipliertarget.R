...
b <- 2 ^ 10
f <- ~ first_last + fd_sal + team + opp + h_a + time + overunder + margin + split(pool, delim = ",") + split(pool_day, delim = ",") - 1
...
view2 <- today_results %>% select(first_last, fd_pos, fd_sal, prediction)

...
dates <- as.character(rev(seq(ymd("2016-10-25"), ymd("2017-01-18"), "day")))
for (d in dates){
...
# write_csv(fin, "vegas_data_raw_0118.csv")
...
write_csv(x, "vegas_odds_swapped.csv")
